function contrast_stepdraw(second)

% This function draws contrast distribution in vascular network after
% certain time.
% i.e: contrast distribution after 10 seconds:
%      contrast_stepdraw(10)
